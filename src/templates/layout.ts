...
<body class="bg-gray-50 dark:bg-[#0a0a0f] min-h-screen transition-colors duration-500">
      ...
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center gap-3">
          ...
          <a href="/" class="flex items-center gap-2.5 group">
            <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-lg shadow-indigo-500/20 group-hover:shadow-indigo-500/40 transition-shadow duration-300 group-hover:scale-105 transition-transform">
  ...
  <!-- Main Content -->
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mesh-bg min-h-[calc(100vh-4rem)]">
    ${content}
  </main>

  <!-- Footer -->
  <footer class="border-t border-gray-200/60 dark:border-white/5 py-6 text-center">
    <p class="text-xs text-gray-400 dark:text-gray-600">LinkMark — Personal Bookmark Manager built on Cloudflare Workers</p>
  </footer>
